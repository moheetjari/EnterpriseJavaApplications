...
public class BlockChainServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<form method='post' action='BlockChainSubmit'>");
            ...
            out.println("</td>");
            out.println("<td>");
            out.println("<input type='text' name='txtFileName' placeholder='Enter filename..' />");
            out.println("</td>");
            out.println("</tr>");
            out.println("<tr>");
            out.println("<td>");
            ...
            out.println("</td>");
            out.println("<td>");
            out.println("<textarea name='txtData' placeholder='Enter data..'></textarea>");
            out.println("</td>");
            out.println("</tr>");
            out.println("<tr>");
            out.println("<td>");
